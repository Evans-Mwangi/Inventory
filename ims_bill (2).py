...
class Bill_App:
    def __init__(self,root):
        ...
        F5=LabelFrame(self.root,bd=10,relief=GROOVE, text="Bill area",font=("times new roman",15,"bold"),fg="gold",bg=bg_color)
        ...
        total_btn=Button(btn_F,command=self.find_bill,bg="Blue",text="Total",fg="Black",pady=15,width=9,bd=5,font="arial 15 bold").grid(row=0,column=0,padx=5,pady=5)
        GBill_btn=Button(btn_F,command=self.bill_area,bg="Blue",text="Generate Bill",fg="Black",pady=15,width=12,bd=5,font="arial 15 bold").grid(row=0,column=1,padx=5,pady=5)
        Clear_btn=Button(btn_F,command=self.clear,bg="Blue",text="Clear",fg="Black",pady=15,width=10,bd=5,font="arial 15 bold").grid(row=0,column=2,padx=5,pady=5)
        Exit_btn=Button(btn_F,command=self.root.destroy,bg="Blue",text="Exit",fg="Black",pady=15,width=10,bd=5,font="arial 15 bold").grid(row=0,column=3,padx=5,pady=5)
        self.welcome_bill()

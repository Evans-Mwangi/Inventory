...
class Stock:
    def __init__(self,root):
        ...
        title=Label(self.root,bd=10,relief=GROOVE,text="Stock Management System",font=("times new roman",40,"bold"),bg="#B2BEB5",fg="black")
        ...
        Manage_Frame=Frame(self.root,bd=4,relief=RIDGE,bg="#0a2351")
        Manage_Frame.place(x=20,y=100,width=450,height=580)

        m_title=Label(Manage_Frame, text="Manage Stocks",bg="#0a2351",fg="white", font=("times new roman",30,"bold"))
        m_title.grid(row=0,columnspan=2,pady=20)

        lbl_item_no=Label(Manage_Frame, text="Item No.",bg="#0a2351",fg="white", font=("times new roman",20,"bold"))
        ...
        lbl_item_name=Label(Manage_Frame, text="Item Name",bg="#0a2351",fg="white", font=("times new roman",20,"bold"))
        ...
        lbl_item_price=Label(Manage_Frame, text="Item Price",bg="#0a2351",fg="white", font=("times new roman",20,"bold"))
        ...
        lbl_item_qty=Label(Manage_Frame, text="Item Quantity",bg="#0a2351",fg="white", font=("times new roman",20,"bold"))
        ...
        #===========Button Frame=============
        btn_Frame=Frame(Manage_Frame,bd=4,relief=RIDGE,bg="#0a2351")
        ...
        Detail_Frame=Frame(self.root,bd=4,relief=RIDGE,bg="#0a2351")
        Detail_Frame.place(x=500,y=100,width=830,height=580)

        lbl_Search=Label(Detail_Frame,text="Search By",bg="#0a2351",fg="white",font=("times new roman",20,"bold"))
        ...
        Table_Frame=Frame(Detail_Frame,bd=4,relief=RIDGE,bg="#0a2351")

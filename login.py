...
class login_system:
    def __init__(self,root):
        ...
        title=Label(self.root,text="MT Inventory",font=("times new roman",40,"bold"),bg="dark blue",fg="red",bd=10,relief=GROOVE)
        title.place(x=0,y=0,relwidth=1)

        Login_Frame=Frame(self.root,bg="")
        ...
        btn_log=Button(Login_Frame,command=self.login,text="Login",width=15,font=("times new roman",14,"bold"),bg="white",fg="grey").grid(row=3,column=1,pady=10)
